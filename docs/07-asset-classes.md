...
> **초안정형(near-cash) 밴드 신설 (2026-07-05 R5, 08 §10)**: Q6=-5% 최보수 고객용 5번째 유형. 성향 4구간 위에 **최하위 티어**로 얹는다. 밴드: **주식 0–10% · 채권(단기 중심, `GOV_LONG` 0) 15–30% · 현금성 `CASH_ST`(SHY) 55–75% · 금 0–5%**. 구성 예시 `SHY 65 / SPY 8 / GLD 8 / (SHY 여분) 19` → σ≈1.9%, VaR95_annual≈3.1%(05 §3 초안정형 상한 -5% 통과). near-cash slot은 SHY 사용(진짜 현금 BIL/SGOV는 20년 미달 → v2 splice). **개인화 배분 아닌 몰개성 "유형 예시"로만 제시** + 기대수익 ~연 2.5%(인플레 미달 가능) 트레이드오프 고지. 실측 발행조건은 §7·M5 게이트(평시 VaR≤-5%).
