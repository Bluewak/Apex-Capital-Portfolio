...
2026-07-02 5개년 실행: 현재 503 + 편출 90 = **593종**, 8 테마군, 세부테마 100% 매칭(현재종목 미매칭 0).
...
- **생존편향·기간 불일치**: 5개년 편입 합집합이라 15년+ 백테스트(01 §5) 유니버스로 쓰면 2021 이전 편출종목이 빠진다. v2 착수 시 룩백 확장 필요(07 §7 미결정).
